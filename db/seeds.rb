...
Pin.create(
  ...
  text: "An interactive, in-browser tutorial for the Ruby programming language. A thorough walkthrough of Ruby's nuances, geared toward beginners.",
  slug: "try-ruby",
  resource_type: "ruby")
Pin.create(
  title: 'Ruby Quiz',
...
Pin.create(
  ...
  text: "Somewhat advanced curriculum, but the exercises are also good for anyone who is motivated and self-guided with experience.",
  slug: "ga-ror-for-developers",
  resource_type: "rails")
Pin.create(
  title: 'Ruby Monk',
  url: 'http://rubymonk.com',
  text: "The Ruby Primer is a free interactive book that helps you learn Ruby. Discover Ruby idioms, learn lessons and solve problems, all in your browser!",
  slug: "ruby-monk",
  resource_type: "ruby")
